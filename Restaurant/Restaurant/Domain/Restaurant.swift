...
extension [Restaurant] {
    var maxLatitude: Double? {
        self.max { $0.latitude > $1.latitude }?.latitude
    }
    var minLatitude: Double? {
        self.min { $0.longitude > $1.longitude }?.latitude
    }
    var maxLongitude: Double? {
        self.max { $0.latitude < $1.latitude }?.longitude
    }
    var minLongitude: Double? {
        self.min { $0.longitude < $1.longitude }?.longitude
    }
}
